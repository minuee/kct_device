...
class CompleteModal extends Component {
  ...
  render() {
    const { isShowCompleteModal, isTaxModal, setVisible, title, subtitle } =
      this.props;
    ...
    return (
      ...
      >
        ...
        <View style={styles.auctionModalBox}>
          <Image
            source={require("../../assets/image/modal/success_graphic_small.png")}
            style={
          ...
          <Text
            style={isTaxModal ? styles.taxModalSubMessasge : styles.subMessage}
          >
            {subtitle}
          </Text>
        </View>
